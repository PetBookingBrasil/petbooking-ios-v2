//
//  AddPetModalViewController.swift
//  petbooking-ios-v2
//
...
protocol AddPetModalDelegate {
    func savePet()
}

class AddPetModalViewController: UIViewController, AddPetModelViewProtocol {
    ...
    var presenter: AddPetModelPresenterProtocol?
...
extension AddPetModalViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
...
extension AddPetModalViewController: SelectPhotoSourcePopupActionProtocol {
...
extension AddPetModalViewController: UIPickerViewDataSource, UIPickerViewDelegate {
