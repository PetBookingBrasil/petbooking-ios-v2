...
class AgendaViewController: UIViewController, AgendaViewProtocol {
    ...
    var scheduledPets = [ScheduledPet]()
    var scheduledServices = [ScheduledService]()
    ...
    override func viewDidLoad() {
        ...
        let cellSize2 = CGSize(width: 106 , height: 88)
    ...
    func getScheduledServices() {
        ...
        PetbookingAPI.sharedInstance.getScheduleList(page: 1) { (scheduledServiceList, message) in
            ...
            guard let scheduledServiceList = scheduledServiceList else { return }
...
extension AgendaViewController: UICollectionViewDelegate, UICollectionViewDataSource, AgendaCollectionViewCellDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, willDisplay cell: UICollectionViewCell, forItemAt indexPath: IndexPath) {
        guard let dateCell = cell as? AgendaCollectionViewCell else { return }
    ...
    func goFoward() {
        guard let currentIndexPath = dateCollectionView.indexPathsForVisibleItems.first else { return }
...
extension AgendaViewController: UITableViewDelegate, UITableViewDataSource, AgendaTableViewCellDelegate, AlertCancelScheduledDelegate {
    ...
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        ...
        return CGFloat(215 + headerSize + service.subServices.count * 30)
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.section >= (scheduledServices.count - 1) {
    ...
    func cancelScheduledService(scheduledService: ScheduledService) {
        PetbookingAPI.sharedInstance.cancelScheduledService(scheduledService: scheduledService) { (success, message) in
            if success {
                ...
                MIBlurPopup.show(AlertPopupRouter.createModule(title: "", message: message), on: self)
            }
        }
    }
}
