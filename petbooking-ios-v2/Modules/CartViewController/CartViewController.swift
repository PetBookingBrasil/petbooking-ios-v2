...
class CartViewController: UIViewController, CartViewProtocol {
  ...
  override func viewDidLoad() {
    ...
    let font14 = UIFont.robotoMedium(ofSize: 14.0)
    let font11 = UIFont.robotoRegular(ofSize: 11)

    let navLabel = UILabel()
    let navTitle = NSMutableAttributedString(string: "Carrinho de Agendamentos" + "\n", attributes: [.foregroundColor: UIColor.white, .paragraphStyle: style, .font: font14] as [NSAttributedStringKey : Any])

    navTitle.append(NSMutableAttributedString(string: business.name, attributes: [.foregroundColor: UIColor.white, .paragraphStyle: style, .font: font11] as [NSAttributedStringKey : Any]))
