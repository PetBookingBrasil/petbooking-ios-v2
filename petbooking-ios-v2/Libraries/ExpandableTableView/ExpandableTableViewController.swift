...
open class ExpandableTableViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    fileprivate func expandCellAtIndexPath(_ indexPath: IndexPath, tableView:UITableView){
        ...
        if tableViewContentOffset.y > 0{
            ...
            tableView.setContentOffset(tableViewContentOffset, animated: true)
        }
    }
